...
describe('workspace-project App', () => {
  ...
  it('should load login component on base url', () => {
    browser.get('/login');
    expect<any>(browser.getCurrentUrl()).toEqual(browser.baseUrl + 'login');
  });

  it('should load signUp component view on clicking SignUp and verify the url', () => {
    browser.get('/login');
    element(by.css('#btn_signUp')).click();
    expect<any>(browser.getCurrentUrl()).toEqual(browser.baseUrl + 'signup');
  });

  it('should contain <router-outlet>', () => {
    page.navigateTo();
    expect(page.getRouterOutlet).toBeTruthy(
      '<router-outlet> should exist in app.component.html'
    );
  });
  ...
  it('should check login form if email is empty', () => {
    ...
    expect<any>(element(by.css('.alert')).getText()).toEqual(
  ...
  it('should check login form if password is empty', () => {
    ...
    element(by.css('#btn_login')).click();
    expect(element(by.css('.alert')).getText()).toContain(
      'All fields are required'
    );
  });
  ...
  it('should load phones component view on clicking phones and verify the url', () => {
    ...
    expect<any>(browser.getCurrentUrl()).toEqual(browser.baseUrl + 'phones');
  });

  it('should load computers component view on clicking computers', () => {
    page.navigateTo();
    element(by.css('#btn-computers')).click();
    expect<any>(browser.getCurrentUrl()).toEqual(browser.baseUrl + 'computers');
  });

  it('should load accessories component view on clicking accessories', () => {
    page.navigateTo();
    element(by.css('#btn-accessories')).click();
    expect<any>(browser.getCurrentUrl()).toEqual(
      browser.baseUrl + 'accessories'
    );
  });
  ...
  it('should load myprofile component view on clicking myprofile', () => {
    ...
    expect<any>(browser.getCurrentUrl()).toEqual(browser.baseUrl + 'myprofile');
  });
  ...
  it('should load myposts component view on clicking myposts', () => {
    ...
    expect<any>(browser.getCurrentUrl()).toEqual(browser.baseUrl + 'myposts');
  });
