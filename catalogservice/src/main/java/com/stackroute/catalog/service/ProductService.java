...
public interface ProductService {
    ...
    Product getProductById(@NotNull(message = "ID cannot be null. Must be a positive integer excluding zero.") @Min(1) long id) throws ProductNotFoundException;
    Product getProductByCode(@NotBlank(message = "Code cannot be empty.") String code) throws ProductNotFoundException;
    Product deleteProduct(@NotNull(message = "ID cannot be null. Must be a positive integer excluding zero.") @Min(1) long id) throws ProductNotFoundException;
